 ...
 * @since 1.0
 */
public class FeedbackInboxActivity extends SherlockListActivity {
...
//        getMenuInflater().inflate(R.menu.jconnect_feedback_inbox_menu, menu);
		...
		inflater.inflate(R.menu.jconnect_feedback_inbox_menu, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home){
        	FeedbackInboxActivity.this.finish();
        }
